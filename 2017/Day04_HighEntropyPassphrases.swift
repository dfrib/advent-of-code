...
extension String {
    var passphrases: [[String.SubSequence]] {
        return split(separator: "\n")
            .map { $0.split(separator: " ") }
    }
    // Part 1.
    var numValidPassphrases1: Int {
        return passphrases
            .filter{ $0.count == Set($0).count }
            .count
    }
    // Part 2.
    var numValidPassphrases2: Int {
        return passphrases
            .map { $0.map { String($0.sorted()) } }
            .filter{ $0.count == Set($0).count }
            .count
    }
}

print("Part 1 =", puzzleInput.numValidPassphrases1) // 455
print("Part 2 =", puzzleInput.numValidPassphrases2) // 186
